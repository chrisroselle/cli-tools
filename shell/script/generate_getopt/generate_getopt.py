...
parser.add_argument('configuration', help='The configuration file that specifies the inputs, in YAML format')
...
try:
    ...
    raise Exception(f'"{cfg["type"]}" is not a valid type - valid types are: {" ".join([x.value for x in GetoptType])}')
...
if positional and positional.multiple:
    print(f'''    local {positional.variable}
